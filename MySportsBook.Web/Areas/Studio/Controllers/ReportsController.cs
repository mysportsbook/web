...
namespace MySportsBook.Web.Areas.Studio.Controllers
{
    ...
    public class ReportsController : BaseController
    {
        ...
        public ActionResult Index(Transaction_Details transaction_Details)
        {
            ...
            //                                             .Select(x => new Transactions { Amount = x.Amount, Description = x.Description, TransactionId = x.PK_IncomeDetailId, EventId = x.FK_EventId, CustomerName = x.Studio_Event.CustomerName, TransactionType = "Credit", CreatedDate = x.CreatedDate, SpendBy = x.Configuration_StudioUser.Name }).ToList();
            ...
            //                                              //.Select(x => new Transactions { Amount = x.Amount, CustomerName = x.Studio_Event.CustomerName, Description = x.Description, EventId = x.FK_EventId, TransactionId = x.PK_ExpenseDetailId, TransactionType = "Debit", SpendBy = x.Configuration_StudioUser.Name, CreatedDate = x.CreatedDate }).ToList();
            //                                              .Select(x => new Transactions { Amount = x.Amount, Description = x.Description, TransactionId = x.PK_ExpenseDetailId, TransactionType = "Debit", SpendBy = x.Configuration_User.FirstName, CreatedDate = x.CreatedDate }).ToList();
