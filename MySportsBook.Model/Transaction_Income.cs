...
namespace MySportsBook.Model
{
    ...
    public partial class Transaction_Income
    {
        public int PK_IncomeId { get; set; }
        public int FK_VenueId { get; set; }
        public int FK_IncomeTypeId { get; set; }
        ...
        public virtual Master_IncomeType Master_IncomeType { get; set; }
